...
// Random ຕົວເລກ index ທີ່ຢູ່ໃນ words
...
function gameOver() {
    gameoverEl.innerHTML = `<h1>ຈົບເກມແລ້ວ</h1>
    <p>ຄະແນນທີ່ໄດ້ = ${score}</p>
    <button onclick = "location.reload()">ເລ່ນອິກ</button>`;
